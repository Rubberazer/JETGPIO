...
Some doxygen documentation [here](https://github.com/Rubberazer/JETGPIO/blob/main/docs/html/index.html). As a rule of thumb, the library functions names and usage mimic the ones of the pigpio library (which I recommend if you work with Raspberry Pis). Learnt a lot from that one
